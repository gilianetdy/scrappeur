...
#1 Récupération de l'email d'une mairie d'une ville du Val d'Oise
def get_townhall_email(townhall_url)
	...
	email_array << {town[3] => email} #on indique la position du nom de la ville dans la string pour la récupérer et => aide à séparer les valeurs 
	puts email_array
	return email_array
end

#2 Récupération des URLs des villes du Val d'Oise
